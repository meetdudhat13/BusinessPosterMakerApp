...
class SearchUpcomingEventByTitleUseCase @Inject constructor(
    private val repository: UpcomingEventRepository,
) {
    suspend operator fun invoke(poster: String) : Resource<List<UpcomingEvent>> = repository.searchUpcomingEventByTitle(poster)
}